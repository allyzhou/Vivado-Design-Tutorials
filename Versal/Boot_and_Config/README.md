...
This tutorial show how to calculate and measure the boot time of the VCK190 evaluation board using different boot modes.


## <a href="./vck190_fallback/">VCK190 Fallback</a>

This tutorial show how to use the fallback capability with the VCK190 evaluation board.


## <a href="./vck190_plm_usb_second/">VCK190 with USB as a Secondary Boot Device</a>

This tutorial show how to program the VCK190 evaluation board using USB as a secondary boot device.
