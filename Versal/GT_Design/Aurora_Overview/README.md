<table class="sphinxhide" width="100%">
 <tr>
   <td align="center"><img src="https://github.com/Xilinx/Image-Collateral/blob/main/xilinx-logo.png?raw=true" width="30%"/><h1>Aurora 64B/66B LogiCore IP Example Design Tutorial</h1>
   </td>
 </tr>
 </table>
