...
These documents provide supplemental material useful with this tutorial:
 1. Versal Architecture and Product Data Sheet: Overview (<a href="https://docs.amd.com/v/u/en-US/ds950-versal-overview">DS950</a>)
 2. Versal AI Core Series Data Sheet: DC and AC Switching Characteristics (<a href="https://docs.amd.com/r/en-US/ds957-versal-ai-core/Summary">DS957</a>)
 3. Versal Adaptive SoC Clocking Resources Architecture Manual (<a href="https://docs.amd.com/r/en-US/am003-versal-clocking-resources/Overview">AM003</a>)
 4. Versal Adaptive SoC SelectIO Resources Architecture Manual (<a href="https://docs.amd.com/r/en-US/am010-versal-selectio/Overview">AM010</a>)
 5. Advanced I/O Wizard LogiCORE IP Product Guide (<a href="https://docs.amd.com/r/en-US/pg320-advanced-io-wizard">PG320</a>)
